...
- [ ] `EntitySwitcher` 컴포넌트 생성
  - 위치: `src/components/layout/entity-switcher.tsx`
...
- [ ] `MemberInviteForm` 컴포넌트 생성
  - 위치: `src/components/membership/member-invite-form.tsx`
...
- [ ] `CreateProofButton` 컴포넌트 생성
  - 위치: `src/components/proof/create-proof-button.tsx`
  - 기능: 위치 증빙 생성 버튼
...
- [ ] `ProofsDataTable` 컴포넌트 생성
  - 위치: `src/components/proof/proofs-data-table.tsx`
...
- [ ] `PlanSelector` 컴포넌트 생성
  - 위치: `src/components/billing/plan-selector.tsx`
  - 기능: 플랜 선택 컴포넌트
  - 위치: `(billing)/plans` 페이지에 배치
...
- [ ] `ManageSubscriptionButton` 컴포넌트 생성
  - 위치: `src/components/billing/manage-subscription-button.tsx`
  - 기능: 결제 포털로 이동하는 버튼
  - 위치: `(billing)/manage` 페이지에 배치
  - Tier 2: `trpc.billing.createBillingPortalSession.useMutation()` 사용
  - 액션: Mutation 호출 후 리디렉션

- [ ] `ClientListTable` 컴포넌트 생성
  - 위치: `src/components/law-agency/client-list-table.tsx`
...
- [ ] `AppManagerTable` 컴포넌트 생성
  - 위치: `src/components/app-manager/app-manager-table.tsx`
